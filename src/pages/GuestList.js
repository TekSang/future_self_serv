    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
      {loginFunctionality && (
        <div>
          ...
          <WelcomeImage size={200} title={coupleName} />
        </div>
      )}
      <div className={classes.search}>
        <InputBase
          placeholder={loginFunctionality ? "Votre nom..." : "Nom, table..."}
          onChange={(e) => {
            if (e.target.value) {
              setEditing(true);
            } else {
                        ...
                        return (
                          <div
                            style={{
                              ...
                              width: "90%",
                              backgroundColor:
                                priorityColors[Math.max(0, Math.min(priorityColors.length - 1, table.priority))],
                              color: "white",
                            }}
                            key={item.id}
                          >
