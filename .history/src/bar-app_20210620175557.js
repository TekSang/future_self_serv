...
export default function BarApp() {
  ...
  function GridRow({ order }) {
    ...
    /*     const height = Math.max(
      inline.products ? inline.products.length : 0,
      Math.max(choosing.products ? choosing.products.length : 0, inprogress.products ? inprogress.products.length : 0)
    ); */

    console.log(inline.products, choosing.products, inprogress.products);
