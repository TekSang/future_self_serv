  ...
  function GridRow({ order, index }) {
    ...
    return (
      <React.Fragment>
        {inline && (
          <Grid item xs={4}>
            <Paper className={classes.paper} style={{ border: `2px solid ${COLORS.redLight}` }}>
              {inline.table}
            </Paper>
          </Grid>
        )}
        {choosing && (
          <Grid item xs={4}>
            <Paper className={classes.paper} style={{ border: `2px solid ${COLORS.yellowLight}` }}>
              {choosing.table}
            </Paper>
          </Grid>
        )}
        {inprogress && (
          <Grid item xs={4}>
            <Paper className={classes.paper} style={{ border: `2px solid ${COLORS.greenDark}` }}>
              {inprogress.table}
            </Paper>
          </Grid>
        )}
