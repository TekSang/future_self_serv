...
export const VALID_PERIOD = 1000 * 60 * 60 * 5; // was 24 but was changed to 8

export const isOrderThan24Hours = Date.now() - localStorage.getItem(LAST_SIGN_IN) > VALID_PERIOD;
