    ...
    <React.Fragment>
      {inline && (
        <Grid item xs={4}>
          <Paper
            ...
            style={{ height: height, overflow: "auto", border: `0.5px solid ${COLORS.redLight}` }}
          >
      ...
      {choosing && (
        <Grid item xs={4}>
          <Paper
            className={classes.paper}
            style={{ height: height, overflow: "auto", border: `0.5px solid ${COLORS.yellowLight}` }}
          >
            <Typography variant="body1" style={{ fontWeight: "bold" }}>
              {choosing.table}
            </Typography>
      ...
      {inprogress && (
        <Grid item xs={4}>
          <Paper
            className={classes.paper}
            style={{ height: height, overflow: "auto", border: `0.5px solid ${COLORS.greenDark}` }}
          >
            <Typography variant="body1" style={{ fontWeight: "bold" }}>
              {inprogress.table}
            </Typography>
