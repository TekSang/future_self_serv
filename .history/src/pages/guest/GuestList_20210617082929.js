...
export default function GuestList({ guests, loginFunctionality, setIsUserLoggedIn }) {
  ...
  const { setUser, setTable, setSwitchApps } = useContext(Context);
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      <div className={classes.search}>
        <InputBase
          placeholder={loginFunctionality ? "Your invitation name..." : "Enter name, table..."}
          onChange={(e) => {
            if (e.target.value.toLocaleLowerCase() === "Switch App".toLocaleLowerCase()) {
              setSwitchApps(true);
            }
