      ...
      <React.Fragment>
        {inline && (
          <Grid item xs={4}>
            <Paper
              ...
              style={{ backgroundColor: index % 2 === 0 ? COLORS.redDark : COLORS.redLight }}
            >
              {inline.table}
            </Paper>
          </Grid>
        ...
        {choosing && (
          <Grid item xs={4}>
            <Paper
              className={classes.paper}
              style={{ backgroundColor: index % 2 === 0 ? COLORS.yellowDark : COLORS.yellowLight }}
            >
              {choosing.table}
            </Paper>
          </Grid>
        ...
        {inprogress && (
          <Grid item xs={4}>
            <Paper
              className={classes.paper}
              style={{ backgroundColor: index % 2 === 0 ? COLORS.greenDark : COLORS.greenLight }}
            >
              {inprogress.table}
            </Paper>
          </Grid>
