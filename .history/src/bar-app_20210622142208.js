  ...
  return (
    <div className={classes.root}>
      ...
      <Grid container spacing={1} className={classes.grid}>
        <Grid direction="row" container item justify="space-around" alignItems="center" xs={12} spacing={3}>
          <Grid item xs={4}>
            <Paper
              className={classes.paper}
        ...
        <Grid direction="row" container item xs={12} spacing={3} justify="space-around" alignItems="center">
          <Grid item xs={4} spacing={1} container direction="column" style={{ backgroundColor: "red" }}>
          ...
          <Grid item xs={4} spacing={1} container direction="column" style={{ backgroundColor: "green" }}>
            <Grid item style={{ marginLeft: "auto", marginRight: "auto", width: "inherit" }}>
              <Paper className={classes.paper}></Paper>
            </Grid>
            <Grid item style={{ marginLeft: "auto", marginRight: "auto", width: "inherit" }}>
          ...
          <Grid item xs={4} spacing={1} container direction="column" style={{ backgroundColor: "blue" }}>
            <Grid item style={{ marginLeft: "auto", marginRight: "auto", width: "inherit" }}>
              <Paper className={classes.paper}></Paper>
            </Grid>
            <Grid item style={{ marginLeft: "auto", marginRight: "auto", width: "inherit" }}>
