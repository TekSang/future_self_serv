  ...
  function GridRow({ order, index }) {
    ...
    return (
      <React.Fragment>
        {inline && (
          <Grid item xs={4}>
            <Paper className={classes.paper} style={{ height: 300, border: `0.5px solid ${COLORS.redLight}` }}>
        ...
        {choosing && (
          <Grid item xs={4}>
            <Paper className={classes.paper} style={{ height: 300, border: `0.5px solid ${COLORS.yellowLight}` }}>
              <Typography variant="body2" style={{ fontWeight: "bold" }}>
                {choosing.table}
              </Typography>
              <List dense={true}>
        ...
        {inprogress && (
          <Grid item xs={4}>
            <Paper className={classes.paper} style={{ height: 300, border: `0.5px solid ${COLORS.greenDark}` }}>
              <Typography variant="body2" style={{ fontWeight: "bold" }}>
                {inprogress.table}
              </Typography>
              <List dense={true}>
