        ...
        <Grid container item xs={12} spacing={3}>
          <Grid item xs={4}>
            <Paper
              ...
              style={{ background: `linear-gradient(45deg, ${COLORS.redDark} 30%, ${COLORS.redDark} 90%)` }}
            >
          ...
          <Grid item xs={4}>
            <Paper
              className={classes.paper}
              style={{ background: `linear-gradient(45deg, ${COLORS.yellowDark} 30%, ${COLORS.yellowDark} 90%)` }}
            >
              <Typography variant="h5" gutterBottom>
                CHOOSING
              </Typography>
          ...
          <Grid item xs={4}>
            <Paper
              className={classes.paper}
              style={{ background: `linear-gradient(45deg, ${COLORS.greenDark} 30%, ${COLORS.greenDark} 90%)` }}
            >
              <Typography variant="h5" gutterBottom>
                IN PROGRESS
              </Typography>
