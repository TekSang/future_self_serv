  ...
  function GridRow({ order, index }) {
    ...
    return (
      <React.Fragment>
        {inline && (
          <Grid item xs={4}>
            <Paper className={classes.paper} style={{ backgroundColor: COLORS.redLight }}>
              {inline.table}
            </Paper>
          </Grid>
        )}
        {choosing && (
          <Grid item xs={4}>
            <Paper className={classes.paper} style={{ backgroundColor: COLORS.yellowLight }}>
              {choosing.table}
            </Paper>
          </Grid>
        )}
        {inprogress && (
          <Grid item xs={4}>
            <Paper className={classes.paper} style={{ backgroundColor: COLORS.greenLight }}>
              {inprogress.table}
            </Paper>
          </Grid>
        )}
        ...
        <Grid container item xs={12} spacing={3}>
          <Grid item xs={4}>
            <Paper
              ...
              style={{ background: `linear-gradient(45deg, ${COLORS.redLight} 30%, ${COLORS.redDark} 90%)` }}
            >
          ...
          <Grid item xs={4}>
            <Paper
              className={classes.paper}
              style={{ background: `linear-gradient(45deg, ${COLORS.yellowLight} 30%, ${COLORS.yellowDark} 90%)` }}
            >
              <Typography variant="h5" gutterBottom>
                CHOOSING
              </Typography>
          ...
          <Grid item xs={4}>
            <Paper
              className={classes.paper}
              style={{ background: `linear-gradient(45deg, ${COLORS.greenDark} 30%, ${COLORS.greenLight} 90%)` }}
            >
              <Typography variant="h5" gutterBottom>
                IN PROGRESS
              </Typography>
