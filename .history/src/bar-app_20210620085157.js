    ...
    <div className={classes.root}>
      ...
      <Grid container spacing={1} className={classes.grid}>
        <Grid container item xs={12} spacing={3}>
          <Grid item xs={4}>
            <Paper className={classes.paper} style={{ background: "linear-gradient(45deg, #FE6B8B 30%, #FF8E53 90%)" }}>
          ...
          <Grid item xs={4}>
            <Paper className={classes.paper} style={{ background: "linear-gradient(45deg, #FFEB01 30%, #FFB600 90%)" }}>
              <Typography variant="h5" gutterBottom>
                CHOOSING
              </Typography>
            </Paper>
          ...
          <Grid item xs={4}>
            <Paper className={classes.paper} style={{ background: "linear-gradient(45deg, #00AD4C 30%, #B3D236 90%)" }}>
              <Typography variant="h5" gutterBottom>
                IN PROGRESS
              </Typography>
            </Paper>
