      ...
      <React.Fragment>
        {inline && (
          <Grid item xs={4}>
            <Paper
              ...
              style={{ background: `linear-gradient(to right, ${COLORS.redLight}, ${COLORS.redDark})` }}
            >
              {inline.table}
            </Paper>
          </Grid>
        ...
        {choosing && (
          <Grid item xs={4}>
            <Paper
              className={classes.paper}
              style={{ background: `linear-gradient(to right, ${COLORS.yellowLight}, ${COLORS.yellowDark})` }}
            >
              {choosing.table}
            </Paper>
          </Grid>
        ...
        {inprogress && (
          <Grid item xs={4}>
            <Paper
              className={classes.paper}
              style={{ background: `linear-gradient(to right, ${COLORS.greenLight}, ${COLORS.greenDark})` }}
            >
              {inprogress.table}
            </Paper>
          </Grid>
      ...
      <Grid container spacing={1} className={classes.grid}>
        <Grid container item xs={12} spacing={3}>
          ...
          <Grid item xs={4}>
            <Paper
              className={classes.paper}
              style={{ background: `linear-gradient(45deg, ${COLORS.greenLight} 30%, ${COLORS.greenDark} 90%)` }}
            >
              <Typography variant="h5" gutterBottom>
                IN PROGRESS
              </Typography>
